            ...
            <div class="page-container" ref={tableContainerRef}>
                <div class="title">Risk of Bias domains</div>
                            ...
                            <tbody>
                                {review.estudos.map((study, studyIndex) => (
                                    <tr>
                                        ...
                                        <td class="centered-image-cell"><img src={verify("overall", reviewId, study.id)} alt="X" class="small-image" /></td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
                    ...
                    <div class="bottom-right-text">
                        Judgement:<br></br>
                        <img src={negative} alt="+" class="bottom-small-image" /> Serious<br></br>
                        <img src={neutral} alt="+" class="bottom-small-image" />Moderate<br></br>
